...
namespace Org.OpenAPITools.io.pharmatrace.api.scin.public.model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Repackage :  IEquatable<Repackage>, IValidatableObject
    {
        /// <summary>
        ...
        public Repackage(long? timestamp = default(long?), string txUid = default(string), string termsId = default(string), string transactionChannel = default(string))
        {
