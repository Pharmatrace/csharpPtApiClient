...
namespace Org.OpenAPITools.io.pharmatrace.api.scin.public.model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InformationQuery :  IEquatable<InformationQuery>, IValidatableObject
    {
        /// <summary>
        ...
        public InformationQuery(long? timestamp = default(long?), string txUid = default(string), string termsId = default(string), string transactionChannel = default(string))
        {
