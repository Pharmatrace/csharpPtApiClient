...
namespace Org.OpenAPITools.io.pharmatrace.api.scin.public.model
{
    ...
    public partial class Containers :  IEquatable<Containers>, IValidatableObject
    {
        ...
        public Containers(int? offset = default(int?), int? limit = default(int?), int? count = default(int?), List<Container> listing = default(List<Container>))
        {
            this.Offset = offset;
            this.Limit = limit;
            this.Count = count;
        ...
        public List<Container> Listing { get; set; }
