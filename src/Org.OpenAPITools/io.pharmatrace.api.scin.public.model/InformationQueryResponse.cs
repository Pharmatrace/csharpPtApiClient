...
namespace Org.OpenAPITools.io.pharmatrace.api.scin.public.model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InformationQueryResponse :  IEquatable<InformationQueryResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public InformationQueryResponse(long? timestamp = default(long?), string txUid = default(string), string termsId = default(string), string transactionChannel = default(string))
        {
